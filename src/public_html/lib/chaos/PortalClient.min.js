    ...
    (function(Portal){
                ...
                SecureCookie.Login=function(guid,passwordGuid,serviceCaller){
                    ...
                    return serviceCaller.CallService("SecureCookie/Login",1,{
                        ...
                        if(response.Error==null){
                            ...
                            CHAOS.Portal.Client.Session.Get(serviceCaller)
                            }
                        })
                };
        ...
        var AuthKey=function(){
            ...
            AuthKey.Create=function(name,serviceCaller){
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("AuthKey/Create",0,{
                    name:name
                })
                };
            ...
            AuthKey.Login=function(token,serviceCaller){
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("AuthKey/Login",1,{
                    token:token
                }).WithCallback(function(response){
                    if(response.Error==null){
        ...
        AuthKey.Delete=function(name,serviceCaller){
            if(typeof serviceCaller==="undefined")serviceCaller=null;
            if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
            return serviceCaller.CallService("AuthKey/Delete",0,{
                name:name
            })
            };
        ...
        (function(Client){
            var MetadataSchema=function(){
                ...
                MetadataSchema.Get=function(guid,serviceCaller){
                    ...
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("MetadataSchema/Get",0,{
                        guid:guid
                    },true)
                    };
                ...
                MetadataSchema.Delete=function(guid,serviceCaller){
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("MetadataSchema/Delete",0,{
                        guid:guid
                    },true)
                    };
            ...
            var Folder=function(){
                ...
                Folder.GetPermission=function(folderID,serviceCaller){
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("Folder/GetPermission",0,{
                        folderID:folderID
                    },true)
                    };
                ...
                Folder.Delete=function(id,serviceCaller){
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("Folder/Delete",0,{
                        id:id
                    },true)
                    };
            ...
            var FolderType=function(){
                ...
                FolderType.Get=function(name,serviceCaller){
                    ...
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("FolderType/Get",0,{
                        name:name
                    },true)
                    };
            ...
            var Format=function(){
                ...
                Format.Get=function(name,serviceCaller){
                    ...
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("Format/Get",0,{
                        name:name
                    },true)
                    };
            ...
            var FormatType=function(){
                ...
                FormatType.Get=function(name,serviceCaller){
                    ...
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("FormatType/Get",0,{
                        name:name
                    },true)
                    };
            ...
            var Language=function(){
                ...
                Language.Get=function(name,languageCode,serviceCaller){
                    ...
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("Language/Get",0,{
                        name:name,
            ...
            var ObjectRelationType=function(){
                ...
                ObjectRelationType.Get=function(value,serviceCaller){
                    ...
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("ObjectRelationType/Get",0,{
                        value:value
                    },true)
                    };
            ...
            var ObjectType=function(){
                ...
                ObjectType.Set=function(name,id,serviceCaller){
                    ...
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("ObjectType/Set",0,{
                        id:id,
                        name:name
                    },true)
                    };
                ...
                ObjectType.Delete=function(id,serviceCaller){
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    if(serviceCaller==null)serviceCaller=CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
                    return serviceCaller.CallService("ObjectType/Delete",0,{
                        id:id
                    },true)
                    };
...
(function(CHAOS){
    (function(Portal){
        (function(Client){
            var PortalClient=function(){
                ...
                PortalClient.prototype.CallService=function(path,method,parameters,requiresSession){
                    ...
                    if(requiresSession)parameters=this.AddSessionToParameters(parameters);
                ...
                PortalClient.prototype.AddSessionToParameters=function(parameters){
                    ...
                    if(!this.HasSession())throw new Error("Session not acquired");
                ...
                PortalClient.prototype.UpdateSession=function(session){
                    ...
                    !hadSession&&session!=null&&this._sessionAcquired.Raise(session)
                    };
            ...
            ServiceCall.prototype.Call=function(callback,path,method,parameters){
                if(typeof parameters==="undefined")parameters=null;
                var _this=this,data=ServiceCall.CreateDataStringWithPortalParameters(parameters);
                if(method==0){
                    path+="?"+data;
                    data=null
                    }
                ...
                if("withCredentials"in this._request){
                    if(callback!=null)this._request.onreadystatechange=function(){
                ...
                this._request.send(data);
                callback!=null&&this._request.responseText!=""&&setTimeout(function(){
                    return _this.ParseResponse(_this._request.responseText)
                    },1)
                }else throw new Error("Browser does not supper AJAX requests");
        };
        
        ServiceCall.prototype.RequestStateChange=function(){
            if(this._request.readyState!=4)return;
            if(this._request.status==200)this.ParseResponse(this._request.responseText);else this.ReportError()
                };
        ...
        ServiceCall.CreateDataString=function(parameters){
            var result="",first=true,value;
            for(var key in parameters){
                value=parameters[key];
                if(value==null)continue;
                if(CHAOS.Portal.Client.Object.prototype.toString.call(value)==="[object Date]")value=ServiceCall.ConvertDate(value);
    ...
    (function(Portal){
        (function(Client){
            ...
            User.Create=function(guid,email,serviceCaller){
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("User/Create",1,{
                    guid:guid,
                    email:email
                })
                };
            ...
            User.Update=function(guid,email,permissons,serviceCaller){
                ...
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("User/Update",1,{
                    guid:guid,
                    email:email,
            ...
            User.Delete=function(guid,serviceCaller){
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("User/Delete",0,{
                    guid:guid
                })
                };
            ...
            User.Get=function(guid,groupGuid,serviceCaller){
                ...
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("User/Get",0,{
                    guid:guid,
                    groupGuid:groupGuid
                })
                };
            ...
            Group.Get=function(guid,userGuid,serviceCaller){
                ...
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("Group/Get",0,{
                    guid:guid,
                    userGuid:userGuid
                })
                };
            ...
            Group.Create=function(name,systemPermission,serviceCaller){
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("Group/Create",0,{
                    name:name,
            ...
            Group.Delete=function(guid,serviceCaller){
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("Group/Delete",0,{
                    guid:guid
                })
                };
            ...
            Group.RemoveUser=function(guid,userGuid,serviceCaller){
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("Group/RemoveUser",0,{
                    guid:guid,
                    userGuid:userGuid
                })
                };
            ...
            ClientSettings.Get=function(guid,serviceCaller){
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("ClientSettings/Get",0,{
                    guid:guid
                })
                };
            ...
            ClientSettings.Set=function(guid,name,settings,serviceCaller){
                if(typeof serviceCaller==="undefined")serviceCaller=null;
                if(serviceCaller==null)serviceCaller=ServiceCallerService.GetDefaultCaller();
                return serviceCaller.CallService("ClientSettings/Set",1,{
                    guid:guid,
                    name:name,
                    settings:settings
                })
        ...
        (function(Client){
            var SecureCookieHelper=function(){
                ...
                SecureCookieHelper.Login=function(callback,serviceCaller){
                    ...
                    if(typeof serviceCaller==="undefined")serviceCaller=null;
                    var _this=this,login=this.GetCookie();
                    if(login==null){
                ...
                SecureCookieHelper.GetCookie=function(){
                    ...
                    var guidRegEx=/SecureCookieGuid\=(.+?)(?:;|$)/,passwordRegex=/SecureCookiePasswordGuid\=(.+?)(?:;|$)/,result={
                        Guid:"",
                        PasswordGuid:""
                    },match=guidRegEx.exec(cookie);
        ...
        (function(Client){
            var Wayf=function(){
                ...
                Wayf.Login=function(wayfServicePath,target,callback,callbackUrl,serviceCaller){
                    ...
                    var reporter,statusRequesterHandle,messageRecieved=function(event){
                        if(event.data.indexOf("WayfStatus: ")!=0)return;
                        reporter!=null&&reporter(event.data.substr(12)=="success")
                        };
                        
                    reporter=function(success){
                        reporter=null;
                        window.removeEventListener("message",messageRecieved,false);
                        statusRequesterHandle!=null&&clearInterval(statusRequesterHandle);
                        success&&serviceCaller.SetSessionAuthenticated(Wayf.AuthenticationType());
                    ...
                    if(callbackUrl!=null)location+="&callbackUrl="+callbackUrl;
                    if(target.location!==undefined&&target.location.href!==undefined){
                        if(target.postMessage)statusRequesterHandle=setInterval(function(){
                            try{
                    ...
                    var sessionChecker=function(){
                        return CHAOS.Portal.Client.User.Get(null,null,serviceCaller).WithCallback(function(response){
                            if(response.Error==null)reporter!=null&&reporter(true);else setTimeout(sessionChecker,1e3)
                                },_this)
                        };
                        
                    setTimeout(sessionChecker,2e3);
                    target.location.href=location
                    }else if(target.src!==undefined)target.src=location;else throw new Error("Unknown target type");
            };
